...
router.get(consts.acts_path(), getActs)
    .post(consts.acts_path(), validators(balanceSchema), createAct)
    .get(consts.act_path(), getAct)
    .post(consts.act_pre_withdrawal_path(), preWithdrawal)
    .get(consts.act_pre_withdrawal_with_id_path(), getPwdWithId)
    .post(consts.act_pre_deposit_path(), preDeposit)
    ...
    .put(consts.act_pre_deposit_with_id_path(), confirmDeposit)
    .put(consts.act_pre_withdrawal_with_id_path(), confirmPwd)
