...
const createPwd = require('../biz/createPwd')
const getAct = require('../biz/getAct')
const getPwdWithId = require('../biz/getPwdWithId')
const createDeposit = require('../biz/createDeposit')
...
router.get(consts.acts_path(),getActs)
    ...
    .post(consts.act_pre_withdrawal_path(), createPwd(accountsState))
    .get(consts.act_pre_withdrawal_with_id_path(), getPwdWithId)
    .post(consts.act_pre_deposit_path(), createDeposit(accountsState))
